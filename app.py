...
Run with: streamlit run Portfolio_Website.py
"""
...
def render_resume():
    ...
    # Embedded PDF viewer + download button (file uploaded earlier to /mnt/data)
    resume_path = "Resume 12_25_2025.pdf"
    st.subheader("📄 Full Résumé (PDF)")
    try:
        display_pdf(resume_path, width=1000, height=900)
        create_download_button(resume_path, "⬇️ Download Résumé PDF", "Andrew_Clark_Resume_12_12_2025.pdf")
    except Exception:
        st.info("Resume PDF not found in /mnt/data — upload it or change the path.")
